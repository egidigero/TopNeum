  ...
  return (
    <Card className="bg-white border-2 border-blue-100 shadow-xl">
        ...
        <CardContent className="p-6 bg-blue-50/30">
          {/* Layout en 3 columnas para aprovechar espacio horizontal */}
          <div className="grid grid-cols-3 gap-6">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="bg-white border-2 border-slate-200 rounded-lg p-4">
                  <div className="space-y-3">{lead.tipo_vehiculo && (
            ...
            {/* Columna 2: Detalle de Compra y Estado */}
            <div className="space-y-4">
              {/* Detalle de Compra */}
